...
| [ADR-010](0010-aa-informed-heuristic-routing.md) | Accepted | Use AA-informed task levels and price-first route resolution without a Benchmark admission gate |
