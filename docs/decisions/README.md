...
| [ADR-014](0014-separate-aa-evidence-packs-from-active-catalogs.md) | Proposed | Separate reusable evidence bindings and full eligible AA snapshots from runtime-derived Active Catalogs |
