...
12. Completed: implement Tasks 20–24, activate the private full-market Free Pack, and complete Checkpoint D4.
...
Phase 4.1 has no remaining implementation blocker. Its former full-market acquisition follow-up was completed by Phase 4.2. Public distribution of a real Evidence Pack remains separately blocked by the ADR-013 written-license gate.

Phase 4.2 has no remaining implementation blocker. The user-owned Free key populated and activated a private full-market Pack. Public redistribution of that real machine-readable Pack remains blocked by the ADR-013 written-license gate; this does not affect local routing or future private refreshes.
