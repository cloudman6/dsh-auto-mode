...
translation-source-blob: ffd5652bdcd1ae141a3ee15cd9a92d0a17bb6260
...
- 关闭限定范围的阶段 0P A5p 载体：模型菜单把带对勾的 `Auto` 放在手动控件上方，并在 Auto 状态卡片中明确标注实际模型/effort；任务运行时从 Session projection 更新该选择与解释；应用手动选择前先退出 Auto。专项测试、完整 GUI 测试、无密钥 assembled-Web golden snapshot 和浏览器 dogfood 均已通过 fork commit `ec5d692166b5fe6f7deb8e5385fe3be2f1a50320`。
